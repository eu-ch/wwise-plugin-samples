...
#ifndef MyAudioInputConfig_H
#define MyAudioInputConfig_H
...
namespace MyAudioInputConfig
{
    static const unsigned short CompanyID = 64;
    static const unsigned short PluginID = 31963;
}

#endif // MyAudioInputConfig_H
